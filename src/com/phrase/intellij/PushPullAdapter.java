...
public class PushPullAdapter {
    ...
    private void runCommand(final String clientAction, final ColorTextPane finalArea) {
        try {
                ...
                public void startNotified(ProcessEvent event) {
                    ApplicationManager.getApplication().invokeLater(new Runnable() {
                        ...
                        public void run() {
                            ...
                            finalArea.appendANSI(getFormattedTime() + "phrase " + clientAction + "\n");
                        }
                    });
                }
            ...
            Notifications.Bus.notify(new Notification("Phrase", "Error", exception.getMessage(), NotificationType.ERROR));
        }
    }
